...
AZURE_MACHINES=55
NUMBER_INSTANCES=1
./scripts/run_mpi_benchmark_v5.sh Senha123 gGEn7CeoUxlkf/EY6sUlrZFg4ebJw3ZkjJ0QvZ5viW0ES+bRDllVwLQy17M9PcWaM4PoRGhqycd9BFE7OadAqg== ${AZURE_MACHINES} ${NUMBER_INSTANCES} 2>&1 | tee -a results/run_mpi_benchmark_v5_${AZURE_MACHINES}_${NUMBER_INSTANCES}.log &
